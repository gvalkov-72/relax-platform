...
<?php $__env->startSection('content'); ?>
    <div class="card">
        <div class="card-body">
            <form method="POST" action="<?php echo e(route('admin.sections.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="tab-pane <?php echo e($loop->first ? 'show active' : ''); ?>"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       class="form-control"
                                       value="<?php echo e(old($lang->code . '.title')); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text"
                                       ...
                                       class="form-control"
                                       value="<?php echo e(old($lang->code . '.subtitle')); ?>">
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('adminlte::page', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\relax-platform\resources\views/admin/sections/create.blade.php ENDPATH**/ ?>