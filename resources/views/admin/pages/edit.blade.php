...
@section('title', __('pages.title.edit'))

@section('content_header')
    <h1>{{ __('pages.title.edit') }}</h1>
@stop
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.pages.update', $page->id) }}">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="template" id="template" class="form-control" required>
                                <option value="default" {{ $page->template == 'default' ? 'selected' : '' }}>{{ __('pages.template.default') }}</option>
                                <option value="home" {{ $page->template == 'home' ? 'selected' : '' }}>{{ __('pages.template.home') }}</option>
                                <option value="contact" {{ $page->template == 'contact' ? 'selected' : '' }}>{{ __('pages.template.contact') }}</option>
                            </select>
                        </div>
                    </div>
                </div>
                ...
                <hr>
                <h4>{{ __('pages.title.edit') }} - {{ __('pages.title.translations') ?? 'Translations' }}</h4>
                ...
                <button type="submit" class="btn btn-success">
                    <i class="fas fa-save"></i> {{ __('pages.button.update') }}
                </button>
